...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $residential_area = filter_input(INPUT_POST, 'residential_area', FILTER_SANITIZE_STRING);
    ...
    $other_social = filter_input(INPUT_POST, 'other_social', FILTER_SANITIZE_URL);
    $message = filter_input(INPUT_POST, 'message', FILTER_SANITIZE_STRING);

    // Validate required fields
    if (!empty($name) && !empty($email) && !empty($tel) && 
        !empty($residential_area) && !empty($business_name) && !empty($message)) {
        
        try {
            // Insert into database
            $stmt = $pdo->prepare("INSERT INTO reseller_applications 
                (name, email, tel, residential_area, business_name, facebook, instagram, pinterest, other_social, message) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                
            $stmt->execute([
                $name, $email, $tel, $residential_area, $business_name, 
                $facebook, $instagram, $pinterest, $other_social, $message
            ]);
            header('Location: index2.php');
            $success = "Thank you for your application! We'll contact you soon.";
...
// Get current day for opening hours (same as index2.php)
$currentDay = date('w');
$days = [
    0 => 'Sunday Closed',
...
<head>
    ...
    <title>Become a Reseller - Gone Waistless</title>  
...
<body>
    ...
    <div class="nav-bar">
     ...
     <div class="reseller-form-container">
        <h1 class="form-title">Become a Reseller</h1>
        ...
        <form method="POST" action="reseller.php">
            ...
            <div class="form-group">
                <label class="required" for="residential_area">Residential Area</label>
                <input type="text" id="residential_area" name="residential_area" class="form-control" required>
            </div>
            
            <div class="form-group">
                <label class="required" for="business_name">Business Name</label>
            ...
            <div class="form-group">
                ...
                <div class="social-links-group">
                    <div>
                        ...
                        <input type="url" id="facebook" name="facebook" class="form-control" placeholder="https://facebook.com/yourpage">
                    </div>
                    <div>
                        <label for="instagram">Instagram</label>
                        <input type="url" id="instagram" name="instagram" class="form-control" placeholder="https://instagram.com/yourprofile">
                    </div>
                    <div>
                        <label for="pinterest">Pinterest</label>
                        <input type="url" id="pinterest" name="pinterest" class="form-control" placeholder="https://pinterest.com/yourprofile">
                    </div>
                    <div>
                        <label for="other_social">Other</label>
                        <input type="url" id="other_social" name="other_social" class="form-control" placeholder="https://example.com">
                    </div>
                </div>
            </div>
            
            <div class="form-group">
                <label class="required" for="message">Tell us about your business</label>
