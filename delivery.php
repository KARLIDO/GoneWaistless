...
<head>
  <meta charset="UTF-8">
  <title>Delivery & Shipping Info | Gone Waistless</title>
...
<div class="container content-container bg-white shadow-sm rounded">
  <h2 class="mb-4">Delivery & Return Information</h2>

  <div class="question">📦 Does Gone Waistless ship internationally?</div>
  <div class="answer">No, only nationwide throughout South Africa.</div>

  <div class="question">💰 How much is shipping?</div>
  <ul>
    <li>Courier (JHB & PTA major centres; 2–5 working days) – <strong>R 100,00</strong></li>
    <li>Courier (JHB & PTA townships; 2–5 working days) – <strong>R 150,00</strong></li>
    <li>Pep/Paxi (Outside Gauteng; 3–5 working days) – <strong>R 109,95</strong></li>
    <li>Pep/Paxi (Outside Gauteng; 7–9 working days) – <strong>R 59,00</strong></li>
  </ul>

  <div class="question">⏳ How long is processing, shipping, and handling?</div>
  <div class="answer">
    Orders are processed within 1–2 business days of receipt and successful payment (Monday to Friday, excluding holidays).<br>
    Orders are shipped every Monday, Wednesday and Friday.
  </div>

  <div class="question">📅 What if I order on a public holiday or weekend?</div>
  <div class="answer">
    Orders placed on public holidays, Saturdays, or Sundays will be processed the following business day.
  </div>

  <div class="question">✏️ Can I make changes to my order?</div>
  <div class="answer">
    Unfortunately not. Orders cannot be altered or changed once your payment is complete.
  </div>

  <div class="question">🔁 May I return my order for a refund or exchange?</div>
  <div class="answer">
    We want our customers to be fully satisfied. You may return items within 7 working days if:
    <ul>
      <li>They're defective or damaged</li>
      <li>They don’t fit or you changed your mind</li>
    </ul>
    <strong>Conditions:</strong> Items must be unwashed, unworn, odour-free, with tags attached, and in original packaging.<br>
    <strong>Returns:</strong> Client pays courier fees. You may return via drop-off at Kyalami Corner or by Paxi (P7218) for orders outside Gauteng.
  </div>

  <div class="question">💸 When will I receive my refund?</div>
  <div class="answer">
    A full refund (excluding shipping) will be issued to your original payment method after your returned item is inspected.<br>
    Refunds are typically processed within <strong>24 – 48 hours</strong> of approval.
  </div>
</div>
<footer class="footer">
