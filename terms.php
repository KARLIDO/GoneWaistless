...
<head>
  <meta charset="UTF-8">
  <title>Terms & Conditions | Gone Waistless</title>
...
@media (max-width: 480px) {
 ...
 body { font-family: 'Arial', sans-serif; background-color: #f8f9fa; }
    ...
    h2, h5 { color: #c2185b; }
    .question { font-weight: bold; margin-top: 25px; }
    .answer { margin-top: 5px; }
    .navbar-brand { font-weight: bold; color: #c2185b !important; }
    </style>
</head>
<body>
...
<div class="container content-container">
  ...
  <p>Welcome to Gone Waistless .</p>

  <p>Please note that You, as a purchaser of Products made available through Gone Waistless products and Your use of Products provided by Gone Waistless is subject to the following terms and conditions (“Terms”).</p>

  <h5>Purchase of Products</h5>
  <p>You must be 18 years of age to purchase Products from Gone Waistless. Please read these Terms carefully prior to indicating Your acceptance.</p>

  <h5>Use of Site</h5>
  <p>You may only use this site to browse the content, make legitimate purchases and shall not use this site for any other purposes... Unauthorized use may violate copyright or other laws.</p>

  <h5>Use of our Website outside South Africa</h5>
  <p>Customers outside South Africa may use the site, but delivery must be within South Africa.</p>

  <h5>Disclaimer of Warranty</h5>
  <p>This site is provided “as is” without warranties of any kind. Gone Waistless and its providers are not liable for any errors, omissions, or damages resulting from the use of this site or content.</p>

  <h5>Our Rights</h5>
  <p>We may modify the website or these terms at any time without notice. It is your responsibility to review these Terms regularly.</p>

  <h5>Online Registration</h5>
  <p>Registration is optional, but enables a better shopping experience. Personal information is stored securely. You may update your details anytime under “My Account”.</p>

  <h5>Methods of Payments</h5>
  <p>We accept EFT (electronic funds transfer) or PayFast.</p>

  <h5>Delivery & Lead Times</h5>
  <p>Read our <a href="delivery.php">Delivery & Returns Policy here</a>.</p>

  <h5>Returns, Changes, Exchanges and Refunds</h5>
  <p>Read our <a href="delivery.php">Delivery & Returns Policy here</a>.</p>

  <h5>Delivery Terms and Conditions</h5>
  <p><strong>Door to door courier:</strong> Ensure correct address and someone is present to accept delivery.</p>
  <p><strong>Undeliverable packages:</strong> If returned to us, we’ll attempt re-shipment. If your error caused it, re-shipping costs apply.</p>
  <p><strong>Order processing:</strong> Begins only after confirmed order and full payment.</p>

  <h5>Monitoring</h5>
  <p>We may monitor activity and content on the site and take necessary action if these Terms are violated.</p>

  <h5>Law</h5>
  <p>The Terms are governed by South African law. We may choose to pursue legal action in other jurisdictions as needed.</p>

  <h5>Updating of these Terms and Conditions</h5>
  <p>We may update these Terms at any time. Continued use of the website indicates your acceptance of changes.</p>

  <h5>Consent</h5>
  <p>You agree not to copy or misuse any trademarks or designs belonging to Gone Waistless. Legal action will be taken against violations.</p>

  <h5>Contact Details</h5>
  <p>Address: Gone Waistless, 2 Kentucky Circle, Saddlebrook, Kyalami, 1684<br>
  Tel: 079 811 8465<br>
  Email: sales@gonewaistless.co.za</p>
</div>
<footer class="footer">
