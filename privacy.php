...
<head>
  <meta charset="UTF-8">
  <title>Privacy Policy | Gone Waistless</title>
...
<div class="container content-container">
  ...
  <p>All the information gathered in the online forms on the website is used to personally identify users that subscribe to this service. The information will not be used for anything other than that which is stated in the Terms & Conditions of use for this service. None of the information will be sold or made available to anyone.</p>
  ...
  <p>Some cookies on this website may do the following:</p>
  <ul>
    <li>Enable you to move around the website and use its features, such as accessing secure areas of the website.</li>
    <li>Improve the user experience and enable some of the functionality provided by this website.</li>
    <li>Collect information about how visitors use the site (e.g., most visited pages, error messages).</li>
    <li>Allow the website to remember choices you make (such as your name or region) and provide enhanced, more personal features.</li>
  </ul>

  <p>The information these cookies collect may be anonymised and cannot track your activity on other websites. These cookies don’t collect information that identifies a visitor. All information collected is aggregated and used only to improve how the website works.</p>

  <p>Please note that some cookies may be placed by third-party service providers who perform services for us. These include: Google Analytics, Facebook share button, Twitter share button, Pinterest share button and Google+ share button. Some may track your behavior on other websites, which we do not control.</p>
</div>
<footer class="footer">
