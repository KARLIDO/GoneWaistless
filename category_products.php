...
error_log("Received category_id: " . $category_id); // Add this line for debugging
...
if ($category_id > 0) {
    ...
    // Add more debug info
    error_log("Fetched category: " . print_r($category, true));
...
<head>
    ...
    <title><?php echo htmlspecialchars($category['name'] ?? 'Category Products'); ?> - <?php echo $siteName; ?></title>
    ...
    <style>
        ...
        .product-card:hover .product-image img {
            transform: scale(1.03); /* Reduced zoom level on hover */
        }
...
<body>
     <div id="loading-overlay">
        <div class="loading-content">
            ...
            <div class="loading-subtext">Preparing your category...</div>
...
<div class="top-bar">
    ...
    <div class="main-content">
       <div class="category-header">
            ...
            <div style="display:none;">
                ...
                Category Name: <?php echo htmlspecialchars($category['name'] ?? 'null'); ?>
            </div>
            
            <h1><?php echo htmlspecialchars($category['name'] ?? 'Category Products'); ?></h1>
                ...
                <?php foreach($products as $product): ?>
                    <div class="product-card">
                        <div class="product-image">
                            <img src="<?php echo htmlspecialchars($product['main_image'] ?? 'assets/products/default.jpg'); ?>" 
     ...
     style="max-width: 100%; max-height: 100%; object-fit: contain;">
                        ...
                        <div class="product-info">
                            ...
                            <button class="add-to-cart" onclick="window.location.href='product.php?id=<?php echo htmlspecialchars($product['id']); ?>'">
        ...
        <?php else: ?>
            <div class="no-products" style="text-align: center; padding: 50px 0;">
                <h3>No products found in this category.</h3>
                <a href="categories.php" class="view-all-btn" style="display: inline-block; margin-top: 20px;">Back to Categories</a>
            </div>
        <?php endif; ?>
    </div>
    <footer class="footer">
    ...
    <!-- Include your footer/scripts from categories.php here -->
    ...
    // Mobile menu toggle
        ...
        document.querySelectorAll('.add-to-cart').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // For example, using AJAX to add to cart without page reload
