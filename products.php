...
<head>
    ...
    <style>
        /* Reuse the styles from index2.php for consistency */
         body {
            margin: 0;
            padding: 0;
...
<div class="top-bar">
        ...
        <div class="container">
            ...
            <div class="products-grid">
                <?php if (!empty($all_products)): ?>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <p class="no-products"><?php echo isset($error_message) ? $error_message : 'No products found.'; ?></p>
                <?php endif; ?>
            </div>
        </div>
    </section>
   <footer class="footer">
    ...
    <!-- Copy the WhatsApp button, chatbot, and footer from index2.php if needed -->
    ...
    <!-- Copy the JavaScript from index2.php -->
    <script>
        // Copy all the JavaScript from index2.php to maintain functionality
