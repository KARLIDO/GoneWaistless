...
<head>
    ...
    <link rel="preload" href="assets/gw1.jpeg" as="image">
    <link rel="preload" href="assets/gw1.webp" as="image" fetchpriority="high">
...
})(window,document,'script','dataLayer','GTM-WZTC8FXS');</script>
<!-- End Google Tag Manager -->
</head>
<body>  <!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WZTC8FXS"
...
<div class="banner-container">
    <div class="blurred-frame">
        <picture>
  <source srcset="assets/gw1.avif" type="image/avif">
  <source srcset="assets/gw1.webp" type="image/webp">
  <img src="assets/gw1.jpeg" 
    ...
    <div class="banner-text left-text">
        <h2 class="script-font">Where Confidence Meets Curves ❤️</h2>
    </div>
        ...
        <div class="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <source srcset="assets/gw1.webp" type="image/webp">
                    <picture>
                    <img src="assets/gw3.jpeg" alt="Promotional Banner 1" class="main-image">
                    </picture>
                </div>
                <div class="carousel-item">
                    <source srcset="assets/gw2.webp" type="image/webp">
                    <picture>
                    <img src="assets/gw2.jpeg" alt="Promotional Banner 2" class="main-image">
                    </picture>
                </div>
                <div class="carousel-item">
                    <source srcset="assets/gw3.webp" type="image/webp">
                    <picture>
                    <img src="assets/gw1.jpeg" alt="Promotional Banner 3" class="main-image">
                    </picture>
                </div>
            </div>
        </div>
    ...
    <div class="banner-text right-text">
        <h2>Shop online for premium pieces.</h2>
        ...
        <section class="categories-section">
            <div class="container">
                ...
                <div class="categories-grid">
                    <?php
                    // Use the $pdo object from config.php
                    if (!$pdo) {
                        echo "";
                    } else {
                        try {
                            // Get featured categories from database using PDO
                            $featured_query = "SELECT c.*, ci.image_path 
                                            FROM categories c
                                            JOIN category_images ci ON c.id = ci.category_id
                                            WHERE c.is_featured = 1 AND ci.is_primary = 1
                                            LIMIT 5";
                            $stmt = $pdo->query($featured_query);
                            $featured_categories = $stmt->fetchAll(PDO::FETCH_ASSOC);
                            
                            if ($featured_categories && count($featured_categories) > 0) {
                                foreach($featured_categories as $category) {
                                    // Fix image path extensions if needed
                                    $image_path = $category['image_path'];
                                    $jpg_path = str_replace('.jpeg', '.jpg', $image_path);
                                    ...
                                    if (file_exists($image_path)) {
                                        ...
                                        $final_path = 'assets/categories/default.jpg';
                                    }
                                    
                                    echo '
                                    <a href="category_products.php?category_id='.$category['id'].'" class="category-card-link">
                                        <div class="category-card">
                                            <div class="category-image">
                                                <img src="'.$final_path.'" alt="'.htmlspecialchars($category['name']).'">
                                            </div>
                                ...
                                // Fallback to hardcoded categories with example IDs
                                $fallback_categories = [
                                    ['id' => 1, 'name' => 'Jumpsuits', 'image_path' => 'assets/categories/jumpsuits.jpeg'],
                                    ['id' => 2, 'name' => 'Waist Trainers', 'image_path' => 'assets/categories/waist-trainers.jpeg'],
                                    ['id' => 3, 'name' => 'Tea', 'image_path' => 'assets/categories/tea.jpeg'],
                                    ['id' => 4, 'name' => 'Bodysuits', 'image_path' => 'assets/categories/bodysuits.jpeg'],
                                    ['id' => 5, 'name' => 'Shapewear', 'image_path' => 'assets/categories/shapewear.jpeg']
                                ];
...
<section class="full-width-image-section">
     <img src="assets/full.png" alt="Full width promotional image" class="full-width-image">
</section>
    ...
    <div class="container">
        ...
        <div class="products-slider">
            <div class="products-track" id="products-track">
                <?php
                // Fetch products from Jumpsuits and Waist Trainers categories
                try {
                    $products_query = "SELECT p.*, 
                              ...
                              WHERE c.name IN ('Jumpsuits', 'Waist Trainers')
                              ORDER BY p.name ASC";
                    ...
                    if ($products && count($products) > 0) {
                        foreach($products as $product) {
                            $price = $product['is_on_sale'] ? $product['sale_price'] : $product['price'];
                            $original_price = $product['is_on_sale'] ? '<span class="original-price">R' . number_format($product['price'], 2) . '</span>' : '';
                            ...
                            <div class="product-card">
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="product.php?id=' . htmlspecialchars($product['id']) . '" class="add-to-cart">
                                        <i class="fas fa-shopping-cart"></i> Choose Options
                                    </a>
                                </div>
                            </div>';
                        }
                    } else {
                        echo '<p class="no-products">No products found in these categories.</p>';
                    }
                } catch (PDOException $e) {
                    echo '<p class="no-products">Unable to load products at this time.</p>';
                }
                ?>
            </div>
            
            <button class="slider-control slider-prev" aria-label="Previous product">&#10094;</button>
            <button class="slider-control slider-next" aria-label="Next product">&#10095;</button>
            
            <div class="slider-dots" id="slider-dots">
                <!-- Dots will be added dynamically by JavaScript -->
            </div>
        </div>
        <div class="view-all-container" style="margin-top: 30px;">
            <a href="products.php" class="view-all-btn">View All Products</a>
        </div>
    </div>
</section>
<!-- Waist Training Section -->
<section class="waist-training-section">
    <div class="waist-training-container">
        <h2 class="waist-training-title">Waist Training Benefits</h2>
        
        <div class="waist-training-content">
            <div class="waist-training-text">
                <p>Waist training is one of the simplest and most effective ways to lose centimeters off your waist. Our waist trainers take it a step further by introducing thermal technology that increases perspiration around your midsection. This in turn helps you burn more fat increasing the resourcefulness of your workouts and regular activities. Our waist trainers are also made of strong material with elastic steel bones that dramatically help your posture.</p>
            </div>
            
            <div class="waist-training-benefits">
                <div class="benefit-item">
                    <div class="benefit-icon"><i class="fas fa-check-circle"></i></div>
                    <div class="benefit-text">INSTANTLY LOSE 5 - 10 CENTIMETERS</div>
                </div>
                
                <div class="benefit-item">
                    <div class="benefit-icon"><i class="fas fa-check-circle"></i></div>
                    <div class="benefit-text">SUPPORT YOUR BACK</div>
                </div>
                
                <div class="benefit-item">
                    <div class="benefit-icon"><i class="fas fa-check-circle"></i></div>
                    <div class="benefit-text">ENHANCE YOUR WORKOUTS</div>
                </div>
                
                <div class="benefit-item">
                    <div class="benefit-icon"><i class="fas fa-check-circle"></i></div>
                    <div class="benefit-text">BOOST CONFIDENCE</div>
                </div>
            </div>
        </div>
        
        <a href="category_products.php?category_id=2" class="shop-waist-trainers-btn">
            SHOP WAIST TRAINERS
        </a>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="testimonials-grid">
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">"Mommy! I got my parcel! OMG the quality is insane 😍 I'm going home for Easter, so look out for the video next week but I'm obsessed.😍"</p>
                <div class="testimonial-author">- Mbali Mdluli</div>
            </div>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">"Good morning!! Thank you so much for prompt delivery!! I've just gone Waistless💃💃💃😁"</p>
                <div class="testimonial-author">- Chantal Thabo</div>
            </div>
        </div>
    </div>
</section>
