...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['update_cart'])) {
        ...
        unset($_SESSION['cart'][$_POST['item_key']]);
        header("Location: cart.php");
        exit();
...
<head>
    ...
    <title>Shopping Cart | Gone Waistless</title>
...
/* For small screens (under 400px) */
@media only screen and (max-width: 400px) {
    /* Make the checkout button full width and properly spaced */
    .btn-checkout {
        display: block;
        width: 100%;
        padding: 12px;
    ...
    /* Adjust the cart summary section */
    .cart-summary {
        flex-direction: column;
        gap: 10px;
    }
    
    /* Style the cart total text */
    .cart-summary h3 {
        margin: 10px 0;
        font-size: 18px;
        text-align: center;
    ...
    /* Make all cart action buttons consistent */
    .cart-actions {
        flex-direction: column;
        gap: 8px;
    }
...
<body>
   <div id="loading-overlay">
        <div class="loading-content">
            ...
            <div class="loading-subtext">Preparing your cart...</div>
...
<div class="top-bar">
    ...
    <!-- Copy your existing header/navigation from product.php -->
            ...
            <form method="post">
                    ...
                    <tbody>
                        <?php foreach ($cart_items as $key => $item): ?>
                            <tr>
                                ...
                                <td>
                                    <button type="submit" name="remove_item" value="1" class="remove-item" formnovalidate>
                ...
                <div class="cart-summary">
                    <div class="cart-actions">
                        ...
                        <button type="submit" name="update_cart" class="btn btn-continue">Update Cart</button>
                        <button type="submit" name="clear_cart" class="btn btn-clear" formnovalidate>Clear Cart</button>
                    </div>
                    
                    <div style="text-align: right;">
                        <h3>Cart Total: R<?php echo number_format($total, 2); ?></h3>
...
window.addEventListener('load', hideLoadingOverlay);
    ...
    <!-- Copy your existing footer/scripts from product.php -->
</body>
</html>